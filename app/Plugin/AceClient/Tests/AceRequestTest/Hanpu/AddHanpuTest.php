...
class AddHanpuTest extends AceRequestTestAbtract
{
    private ?string $testMemberId = '221';
    private ?string $testSessid = '777777777777';
    ...
    public function testRequestAddHanpuNormalOK()
    {
        try {
    ...
    public function testSerializeAddHanpuNormal()
    {
        $requestModel = $this->getAddHanpuModel();
        ...
        {$soapHead}
            <addHanpu xmlns="{$xmlns}">
                ...
                <mailjyuden>
                    ...
                    <mail>addHanpuTest@AceClient.v1.0</mail>
                </mailjyuden>
                </hanpu>
                ]]></prm>
                <id>13</id>
    ...
    public function testRequestAddHanpuNormalNG()
    {
        try {
            $addHanpuRequest = $this->getAddHanpuModel()->setId(-1)->setSessId("NG");
            $response = $this->aceClient->makeHanpuService()
                                        ->makeAddHanpuMethod()
                                        ->withRequest($addHanpuRequest)
                                        ->send();
