...
use Plugin\AceClient43\AceServices\Model\Request\Goods\GetGoods\GetGoodsRequestModel;
    ...
    public function testRequestGetGoodsOK()
    {
        try {
            ...
            if ($response->getStatusCode() === 200) {
                ...
                $goods1 = $this->getGood('203', $goods);
                $goods2 = $this->getGood('201', $goods);
                $goods84 = $this->getGood('n-1', $goods);
