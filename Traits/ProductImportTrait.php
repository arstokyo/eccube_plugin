...
trait ProductImportTrait
{
     ...
     */
    protected function validateDateTimeOptions(InputInterface $input, OutputInterface $output, string $defaultFrom = '-1 month', string $defaultTo = '+1 day'): ?array
    {
     ...
     * @return Member|null
     */
    protected function validateCreatorId(InputInterface $input, OutputInterface $output, MemberRepository $memberRepository): ?Member
    {
     ...
     */
    protected function removeEntities(array $entities, OutputInterface $output, EntityManagerInterface $entityManager, ManagerRegistry $managerRegistry): void
    {
        $removed = 0;
        $failed = 0;
        ...
        foreach ($entities as $entity) {
            try {
                $entityManager = EntityManagerResetHelper::resetIfNotOpen($entityManager, $managerRegistry, $output);
                ...
                $entityManager = EntityManagerResetHelper::resetEntityManager($entityManager, $managerRegistry, $output);
            } catch (\Throwable $e) {
