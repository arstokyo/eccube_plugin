...
use Plugin\AceClient43\Traits\CommandUtilTrait;
...
abstract class AbstractProductImportCommand extends Command
{
     ...
     * @return int
     */
    abstract protected function executeImport($creator, \DateTime $updateFrom, \DateTime $updateTo, array $options, LoggerInterface $logger): int;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $importedCount = $this->executeImport($creator, $updateFrom, $updateTo, $options, $logger);
