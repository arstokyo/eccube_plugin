...
class AddCartTest extends AbstractAdminWebTestCase
{
    ...
    public function testRequestAddCartOK()
    {
        ...
        $this->assertEquals('40420519', $jyuden->getDay()->toApiDateTime());
        $this->assertEquals('4042-05-19', $jyuden->getDay()->toShortDate());
        $this->assertEquals('40420519', $jyuden->getYday()->toApiDateTime());
        $this->assertEquals('4042-05-19', $jyuden->getYday()->toShortDate());
        $this->assertEquals(null, $jyuden->getSday());
        $this->assertEquals(null, $jyuden->getUday());
        $this->assertEquals(null, $jyuden->getNday());
        $this->assertEquals('40420602', $jyuden->getHday()->toApiDateTime());
        $this->assertEquals('4042-06-02', $jyuden->getHday()->toShortDate());
