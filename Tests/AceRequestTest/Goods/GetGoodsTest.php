...
class GetGoodsRequestModelTest extends AceRequestTestAbtract
{
    ...
    public function testRequestGetGoodsOK()
    {
        ...
        $this->assertEquals("202", $goods84->getGdid());
        $this->assertEquals(0, $goods84->getTkbn());
        $this->assertEquals(0, $goods84->getGkbn());
        $this->assertEquals(0, $goods84->getKake());
        $this->assertEquals(0, $goods84->getSkbn());
        $this->assertEquals(0, $goods84->getNprint());
        $this->assertEquals(0, $goods84->getZkbn());
        $this->assertEquals("15", $goods84->getKikaku1());
        $this->assertEquals("3", $goods84->getKikaku2());
        $this->assertEquals("GetGoodMsManyテストshouショウヒン１", $goods84->getKana());
        $this->assertEquals("GetGoodsManyテスト商品1", $goods84->getGname());
        $this->assertEquals("GetGoodsManyテスト1", $goods84->getSubName());
        $this->assertEquals("", $goods84->getTani());
        $this->assertEquals("99999999", $goods84->getBarcode());
        $this->assertEquals(0, $goods84->getKonpo());
