...
class Events
{
    ...
    public const PRE_CREATE_IN_ACE_CUSTOMER_ADDRESS = 'ace_client.pre_create_in_ace_customer_address';
    public const POST_CREATE_IN_ACE_CUSTOMER_ADDRESS = 'ace_client.post_create_in_ace_customer_address';
